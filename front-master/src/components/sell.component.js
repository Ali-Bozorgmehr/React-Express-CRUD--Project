...
class SellHouse extends Component {
  constructor(props) {
    ...
    this.onChangeSold = this.onChangeSold.bind(this);
  ...
  getHouse(id) {
    HouseDataService.getSellAuth(id)
      .then((response) => {
        this.setState({
  ...
  updateHouse() {
    HouseDataService.updateSellAuth(
  ...
  deleteHouse() {
    HouseDataService.deleteSellAuth(this.state.currentHouse.id)
      .then((response) => {
        console.log(response.data);
        this.props.router.navigate("/auth/dashboard/sells");
      })
      .catch((e) => {
        console.log(e);
      });
        ...
        {currentHouse ? (
          <div className="edit-form">
            ...
            <Form>
              ...
              <Form.Group className="p-2" controlId="sold">
                <Form.Select
                  onChange={this.onChangeSold}
                  value={currentHouse.sold}
                >
                  <option value="" disabled selected>
                    Sold
                  </option>
...
export default withRouter(SellHouse);
